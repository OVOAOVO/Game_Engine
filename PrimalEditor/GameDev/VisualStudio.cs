...
namespace PrimalEditor.GameDev
{
    static class VisualStudio
    {
        ...
        [DllImport("ole32.dll")]
        private static extern int CreateBindCtx(uint reversed, out IBindCtx ppbc);

        [DllImport("ole32.dll")]
        private static extern int GetRunningObjectTable(uint reversed, out IRunningObjectTable pprot);
        public static void OpenVisualStudio(string solutionPath)
        {
            ...
            catch(Exception ex)
            {
                ...
                Logger.Log(MessageType.Error, "faild to open Visual Studio");
            }
            finally
            {
        ...
        public static bool AddFilesToSolution(string solution, string projectName, string[] files)
        {
            ...
            {
                Debug.WriteLine(ex.Message);
                Debug.WriteLine("faild to add file to Visual Studio project");
                return false;
            }
            return true;
        }
